<section class="toolkits hide" id="toolkits">
	...
	<div id="toolBar" class="toolBar">
		...
		<img id="save-btn" class="temp icon" src="icon/save.png">
		<input type="text"  name="save-work" class="temp hide" id="save-work" value="">
		<input type="text" name="save-path" class="temp hide" id="save-path" value="">
		</form>
